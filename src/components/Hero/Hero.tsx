...
const TRUST_BADGES = [
  ...
  { icon: 'uptime', label: '99.99% Uptime' },
  { icon: 'chart', label: 'Portfolio-grade Reporting' },
];
        ...
        <div className="grid min-h-screen grid-cols-1 items-center gap-8 py-20 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="flex flex-col justify-center lg:pr-8">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl xl:text-7xl">
              <span className="block">See Every Asset.</span>
              <span className="block text-gradient-blue mt-1">Control Every Outcome.</span>
            </h1>

            {/* Subtext */}
            <p className="mt-6 max-w-xl text-lg text-gray-400 leading-relaxed sm:text-xl">
              Real-time operational visibility for commercial infrastructure portfolios. 
              Built for asset managers who need certainty.
            </p>
